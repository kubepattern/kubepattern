...
public class RelationshipAnalyzerConfig {
    ...
    @Bean
    public ReferencesKrateoStrategy referencesKrateoStrategy() { return new ReferencesKrateoStrategy(); }

    @Bean ManagesKrateoStrategy managesKrateoStrategy() { return new ManagesKrateoStrategy(); }
