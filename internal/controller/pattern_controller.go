...
// +kubebuilder:rbac:groups=kubepattern.kubepattern.dev,resources=patterns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubepattern.kubepattern.dev,resources=patterns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kubepattern.kubepattern.dev,resources=patterns/finalizers,verbs=update
